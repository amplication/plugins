...
export const useLoggerInMain = (srcDir: string, modules: ModuleMap, logger: BuildLogger) => {
    ...
    visit(mainCode, {
        visitVariableDeclaration: function (path) {
            ...
            args[1].properties.push(b.objectProperty(
                b.identifier("bufferLogs"),
                b.literal(true)
            ))
