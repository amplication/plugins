              ...
              return {
                ...
                sendEmail: async function(input) {
                  if(input.type === "PASSWORD_RESET") {
                    ...
                    console.log("The password reset link:", input.passwordResetLink);
                  } else {
              ...
              return {
                ...
                createCodePOST: async function(input) {
                  if(originalImplementation.createCodePOST === undefined) {
                    throw new Error("original implementation's createCodePOST is undefined");
                  }
                ...
                consumeCodePOST: async function(input) {
                  if(originalImplementation.consumeCodePOST === undefined) {
                    throw new Error("original implementation's consumeCodePOST is undefined");
                  }
                  let session = await Session.getSession(input.options.req, input.options.res, {
                    overrideGlobalClaimValidators: () => []
                  });
